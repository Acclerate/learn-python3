...
/******************************************/
CREATE TABLE hsa_vms_yt_02.`dws_jjsz_fund_pay_mi_ytai` (
...
/******************************************/
CREATE TABLE hsa_vms_yt_02.`dws_jjsz_fund_pay_rsdt_year_mi_ytai` (
  `setl_amt` varchar COMMENT '结算金额',
  `setl_amt_cr` varchar COMMENT '',
  `setl_amt_sr` varchar COMMENT '',
  `setl_cnt` varchar COMMENT '结算人次',
...
/******************************************/
CREATE TABLE hsa_vms_yt_02.`dws_jjsz_hosp_rank_pay_mi_ytai` (
  `stt_ym` varchar COMMENT '',
...
/******************************************/
CREATE TABLE hsa_vms_yt_02.`dws_jjsz_setl_d_pay_mi_ytai` (
  `stt_ym` varchar COMMENT '',
...
/******************************************/
CREATE TABLE hsa_vms_yt_02.`dws_outmed_setl_d_yt` (
...
/******************************************/
CREATE TABLE hsa_vms_yt_02.`dws_outmed_setl_info` (
...
/******************************************/
CREATE TABLE hsa_vms_yt_02.`dws_setl_d_fixmedins_type` (
...
/******************************************/
CREATE TABLE hsa_vms_yt_02.`fee_list_d_day` (
...
/******************************************/
CREATE TABLE hsa_vms_yt_02.`fixmedins_b` (
...
/******************************************/
CREATE TABLE hsa_vms_yt_02.`inhosp_cnt_day` (
  `partition_id` varchar COMMENT '',
  `rid` varchar COMMENT '',
...
/******************************************/
CREATE TABLE hsa_vms_yt_02.`mdtrt_d_day` (
  `partition_id` varchar COMMENT '',
  `rid` varchar COMMENT '',
  `insu_admdvs` varchar COMMENT '',
...
/******************************************/
CREATE TABLE hsa_vms_yt_02.`mdtrt_d_realtime_ytai` (
...
/******************************************/
CREATE TABLE hsa_vms_yt_02.`otp_bigscreen_test` (
...
/******************************************/
CREATE TABLE hsa_vms_yt_02.`out_appy_d` (
...
/******************************************/
CREATE TABLE hsa_vms_yt_02.`setl_d_day` (
  `partition_id` varchar COMMENT '',
  `rid` varchar COMMENT '',
  `setl_time` varchar COMMENT '',
  `setl_hours` varchar COMMENT '',
...
/******************************************/
CREATE TABLE hsa_vms_yt_02.`setl_d_realtime_ytai` (
...
/******************************************/
CREATE TABLE hsa_vms_yt_02.`stg_midr_bus_xzxksx_info_df_ytai` (
...
/******************************************/
CREATE TABLE hsa_vms_yt_02.`stg_tp_opsp_reg_d_df_v_ytai` (
...
/*   TableName = drord_d   */
/******************************************/
CREATE TABLE hsa_vms_yt_01.`drord_d` (
...
/******************************************/
CREATE TABLE hsa_vms_yt_01.`dws_setl_d_with_hosplv` (
...
/******************************************/
CREATE TABLE hsa_vms_yt_01.`dws_setl_d_with_hosplv_labl` (
  `inhos_cnt` varchar COMMENT '',
...
/******************************************/
/*   DatabaseName = hsa_vms_yt_02   */
/*   TableName = fee_list_d_inhosp_day   */
/******************************************/
CREATE TABLE hsa_vms_yt_02.`fee_list_d_inhosp_day` (
  `partition_id` varchar COMMENT '',
  `rid` varchar disableIndex true COMMENT '',
  `insu_admdvs` varchar COMMENT '',
  `fee_ocur_time` varchar COMMENT '',
  `insutype` varchar COMMENT '',
  `fixmedins_code` varchar COMMENT '',
  `fixmedins_name` varchar COMMENT '',
  `dise_no` varchar COMMENT '',
  `dise_name` varchar COMMENT '',
  `hilist_name` varchar COMMENT '',
  `med_chrgim_type` varchar COMMENT '',
  `sumamt` decimal(16, 2) disableIndex true COMMENT '',
  `crte_time` timestamp disableIndex true COMMENT '',
  `list_type` varchar disableIndex true COMMENT '',
  `cnt` bigint COMMENT '',
  PRIMARY KEY (`partition_id`,`fee_ocur_time`,`insu_admdvs`,`insutype`,`fixmedins_code`,`fixmedins_name`,`dise_no`,`dise_name`,`hilist_name`,`med_chrgim_type`,`list_type`)
)
PARTITION BY HASH KEY (`partition_id`) PARTITION NUM 256
TABLEGROUP hsa_vms_yt_02
OPTIONS (UPDATETYPE='realtime')
...
/******************************************/
/*   DatabaseName = hsa_vms_yt_02   */
/*   TableName = insu_emp_info_b   */
/******************************************/
CREATE TABLE hsa_vms_yt_02.`insu_emp_info_b` (
  `emp_no` varchar NOT NULL COMMENT '单位编号',
  `emp_entt_codg` varchar COMMENT '单位实体编码',
  `emp_mgt_type` varchar NOT NULL COMMENT '单位管理类型',
  `prnt_emp_no` varchar COMMENT '上级单位编号',
  `asoc_legent_flag` varchar NOT NULL COMMENT '关联法人标志',
  `emp_type` varchar COMMENT '单位类型',
  `emp_name` varchar NOT NULL COMMENT '单位名称',
  `reg_name` varchar COMMENT '注册名称',
  `loc_admdvs` varchar COMMENT '所属医保区划',
  `coner_name` varchar COMMENT '联系人姓名',
  `coner_email` varchar COMMENT '联系人电子邮箱',
  `tel` varchar COMMENT '联系电话',
  `fax_no` varchar COMMENT '传真号码',
  `tax_reg_no` varchar COMMENT '税务登记号',
  `orgcode` varchar COMMENT '组织机构代码',
  `regno` varchar COMMENT '注册号',
  `regno_cert_type` varchar COMMENT '注册号证件类型',
  `emp_addr` varchar NOT NULL COMMENT '单位地址',
  `poscode` varchar COMMENT '邮政编码',
  `aprv_esta_dept` varchar COMMENT '批准成立部门',
  `aprv_esta_date` timestamp COMMENT '批准成立日期',
  `aprv_esta_docno` varchar COMMENT '批准成立文号',
  `prnt_admdvs` varchar COMMENT '上级医保区划',
  `insu_admdvs` varchar COMMENT '参保所属医保区划',
  `org_vali_stas` varchar COMMENT '组织有效状态',
  `legrep_tel` varchar COMMENT '法定代表人电话号码',
  `legrep_name` varchar COMMENT '法定代表人姓名',
  `legrep_cert_type` varchar COMMENT '法定代表人证件类型',
  `legrep_certno` varchar COMMENT '法定代表人证件号码',
  `orgcode_issu_emp` varchar COMMENT '组织机构代码证颁发单位',
  `vali_flag` varchar NOT NULL COMMENT '有效标志',
  `rid` varchar NOT NULL COMMENT '数据唯一记录号',
  `crte_time` timestamp NOT NULL COMMENT '数据创建时间',
  `updt_time` timestamp NOT NULL COMMENT '数据更新时间',
  `crter_id` varchar NOT NULL COMMENT '创建人id',
  `crter_name` varchar NOT NULL COMMENT '创建人姓名',
  `crte_optins_no` varchar NOT NULL COMMENT '创建机构编号',
  `opter_id` varchar NOT NULL COMMENT '经办人id',
  `opter_name` varchar NOT NULL COMMENT '经办人姓名',
  `opt_time` timestamp NOT NULL COMMENT '经办时间',
  `optins_no` varchar NOT NULL COMMENT '经办机构编号',
  `poolarea_no` varchar COMMENT '统筹区编号',
  `ver` varchar COMMENT '版本号',
  `sync_prnt_flag` varchar COMMENT '同步上级标志',
  `entp_spec_flag` varchar COMMENT '企业规格标志',
  `memo` varchar COMMENT '备注',
  `org_quts_psncnt` int COMMENT '机关编制人数',
  PRIMARY KEY (`emp_no`,`emp_mgt_type`,`poolarea_no`)
)
PARTITION BY HASH KEY (`emp_no`) PARTITION NUM 256
TABLEGROUP hsa_vms_yt_02
OPTIONS (UPDATETYPE='realtime')
COMMENT '参保单位信息表'
;
...
/******************************************/
/*   DatabaseName = hsa_vms_yt_02   */
/*   TableName = medins_info_b   */
/******************************************/
CREATE TABLE hsa_vms_yt_02.`medins_info_b` (
  `medins_code` varchar COMMENT '',
  `uscc` varchar COMMENT '',
  `medins_name` varchar COMMENT '',
  `medins_abbr` varchar COMMENT '',
  `fax_no` varchar COMMENT '',
  `main_resper` varchar COMMENT '',
  `admdvs` varchar COMMENT '',
  `addr` varchar COMMENT '',
  `medins_type` varchar COMMENT '',
  `medins_type_name` varchar COMMENT '',
  `fixmedins_type` varchar COMMENT '',
  `reg_stas` varchar COMMENT '',
  `enrd_staf_psncnt` bigint COMMENT '',
  `hosp_dept_cnt` bigint COMMENT '',
  `hosp_key_dept_cnt` bigint COMMENT '',
  `senr_profttl_psncnt` bigint COMMENT '',
  `mid_profttl_psncnt` bigint COMMENT '',
  `pro_techstf_psncnt` bigint COMMENT '',
  `depsenr_profttl_psncnt` bigint COMMENT '',
  `aprv_bed_cnt` bigint COMMENT '',
  `biz_psncnt` bigint COMMENT '',
  `oth_psncnt` bigint COMMENT '',
  `biz_area` varchar COMMENT '',
  `medinslv` varchar COMMENT '',
  `hosp_lv` varchar COMMENT '',
  `lnt` varchar COMMENT '',
  `lat` varchar COMMENT '',
  `begntime` timestamp COMMENT '',
  `endtime` timestamp COMMENT '',
  `memo` varchar COMMENT '',
  `grst_hosp_flag` varchar COMMENT '',
  `cred_lv` varchar COMMENT '',
  `cred_lv_name` varchar COMMENT '',
  `prnt_medins_code` varchar COMMENT '',
  `vali_flag` varchar COMMENT '',
  `medins_natu` varchar COMMENT '',
  `medins_natu_name` varchar COMMENT '',
  `npmo_flag` varchar COMMENT '',
  `rid` varchar COMMENT '',
  `crter_id` varchar COMMENT '',
  `crter_name` varchar COMMENT '',
  `crte_time` timestamp COMMENT '',
  ...
  `optins_no` varchar COMMENT '',
  `ver` varchar COMMENT '',
  `sync_prnt_flag` varchar COMMENT '',
  `medins_grade` varchar COMMENT '',
  PRIMARY KEY (`medins_code`,`rid`,`admdvs`,`medins_name`)
)
PARTITION BY HASH KEY (`rid`) PARTITION NUM 128
TABLEGROUP hsa_vms_yt_02
OPTIONS (UPDATETYPE='realtime')
...
/******************************************/
/*   DatabaseName = hsa_vms_yt_02   */
/*   TableName = stg_zffs_drgkd37proc_mf_ytai   */
/******************************************/
CREATE TABLE hsa_vms_yt_02.`stg_zffs_drgkd37proc_mf_ytai` (
  `stt_ym` varchar COMMENT '年月',
  `fixmedins_code` varchar COMMENT '定点医疗机构编码',
  `trt_type` varchar COMMENT '待遇大类（1：职工 2：居民 3：其他）',
  `drg_code` varchar COMMENT 'DRG编码',
  `drg_name` varchar COMMENT 'DRG名称',
  `psntime` decimal(20, 2) COMMENT '人次',
  `psncnt` decimal(20, 2) COMMENT '人数',
  `sumfee` decimal(20, 2) COMMENT '总费用',
  `trtfee` decimal(20, 2) COMMENT '医技费用',
  `drugfee` decimal(20, 2) COMMENT '药品费用',
  `matlfee` decimal(20, 2) COMMENT '耗材费用',
  `bedday` decimal(20, 2) COMMENT '住院天数',
  `sevend_rinp` decimal(20, 2) COMMENT '7天再住院',
  `fourtd_rinp` decimal(20, 2) COMMENT '14天再住院',
  `ownpay_amt` decimal(20, 2) COMMENT '自费费用',
  `fixmedins_code_h` varchar COMMENT '定点医疗机构编码H',
  `fixmedins_name` varchar COMMENT '定点医疗机构编码',
  `fixmedins_type` varchar COMMENT '定点医疗机构编码',
  PRIMARY KEY (`stt_ym`,`fixmedins_code`,`trt_type`,`DRG_CODE`)
)
...
CREATE TABLE hsa_vms_yt_01.`adm_eval_rcd` (
  `adm_eval_rcd_sn` varchar COMMENT '入院评估记录流水号',
  `medins_uscc` varchar COMMENT '医疗机构统一社会信用代码',
  `mdtrt_cert_no` varchar COMMENT '就诊凭证编号',
  `mdtrt_cert_type` varchar COMMENT '就诊凭证类型',
  `age_year` int COMMENT '年龄（岁）',
  `age_mon` varchar COMMENT '年龄（月）',
  `age_h` varchar COMMENT '年龄（小时）',
  `ipt_mdtrt_sn` varchar COMMENT '住院就诊流水号',
  `ipt_no` varchar COMMENT '住院号',
  `dept_name` varchar COMMENT '科室名称',
  `dept_code` varchar COMMENT '科室代码',
  `wardarea_name` varchar COMMENT '病区名称',
  `wardno` varchar COMMENT '病房号',
  `bedno` varchar COMMENT '病床号',
  `patn_name` varchar COMMENT '患者姓名',
  `gend` varchar COMMENT '性别',
  `naty` varchar COMMENT '民族',
  `ntly` varchar COMMENT '国籍',
  `mrg_stas` varchar COMMENT '婚姻状态',
  `educ` varchar COMMENT '学历',
  `prfs` varchar COMMENT '职业',
  `patn_tel` varchar COMMENT '患者电话号码',
  `empr_tel` varchar COMMENT '工作单位联系电话',
  `patn_elec_email` varchar COMMENT '患者电子邮件地址',
  `coner_name` varchar COMMENT '联系人姓名',
  `coner_tel` varchar COMMENT '联系人电话号码',
  `adm_diag_codg` varchar COMMENT '入院诊断编码',
  `adm_diag_name` varchar COMMENT '入院诊断名称',
  `adm_date` timestamp COMMENT '入院日期时间',
  `main_symp` varchar COMMENT '主要症状',
  `tpert` decimal(4, 1) COMMENT '体温（℃）',
  `sbp` decimal(3, 0) COMMENT '收缩压(mmHg)',
  `dbp` decimal(3, 0) COMMENT '舒张压(mmHg)',
  `wt` decimal(5, 2) COMMENT '体重（kg）',
  `brat_frqu` decimal(3, 0) COMMENT '呼吸频率（次/min）',
  `pule` decimal(3, 0) COMMENT '脉率（次/min）',
  `adm_rea` varchar COMMENT '入院原因',
  `adm_way` varchar COMMENT '入院途径',
  `apgar_sco` int COMMENT 'Apgar评分',
  `diet_cond` varchar COMMENT '饮食情况',
  `devt_deg` varchar COMMENT '发育程度',
  `mtl_stas_flag` varchar COMMENT '精神状态正常标志',
  `slep_info` varchar COMMENT '睡眠情况',
  `sp_info` varchar COMMENT '特殊情况',
  `mind_stas` varchar COMMENT '心理状态',
  `nurt_stas` varchar COMMENT '营养状态',
  `adl` varchar COMMENT '自理能力',
  `hlcon` varchar COMMENT '健康状况',
  `disehis_trum` varchar COMMENT '疾病史（含外伤）',
  `patn_ifen_flag` varchar COMMENT '患者传染性标志',
  `ifet_dise_his` varchar COMMENT '传染病史',
  `prev_vcnt_his` varchar COMMENT '预防接种史',
  `oprn_his` varchar COMMENT '手术史',
  `bld_his` varchar COMMENT '输血史',
  `algs` varchar COMMENT '过敏史',
  `fmhis` varchar COMMENT '家族史',
  `nurscare_obsv_item_name` varchar COMMENT '护理观察项目名称',
  `nurscare_obsv_rslt` varchar COMMENT '护理观察结果',
  `smok_flag` varchar COMMENT '吸烟标志',
  `stop_smok_days` decimal(3, 0) COMMENT '停止吸烟天数',
  `smok_stas` varchar COMMENT '吸烟状况',
  `day_smok_amt` decimal(3, 0) COMMENT '日吸烟量（支）',
  `drnk_flag` varchar COMMENT '饮酒标志',
  `drnk_frqu` varchar COMMENT '饮酒频率',
  `day_drnk_amt` decimal(3, 0) COMMENT '日饮酒量（mL）',
  `notc_dr_flag` varchar COMMENT '通知医师标志',
  `notc_dr_date` timestamp COMMENT '通知医师日期时间',
  `eval_date` timestamp COMMENT '评估日期时间',
  `resp_nurs_name` varchar COMMENT '责任护士姓名',
  `resp_nurs_empno` varchar COMMENT '责任护士工号',
  `accept_nurs_name` varchar COMMENT '接诊护士姓名',
  `accept_nurs_empno` varchar COMMENT '接诊护士工号',
  `resp_nurs_sign_date` timestamp COMMENT '责任护士签名日期时间',
  `accept_nurs_sign_date` timestamp COMMENT '接诊护士签名日期时间',
  `rcd_date` timestamp COMMENT '记录日期时间',
  `rcder_empno` varchar COMMENT '记录人工号',
  `rcder_name` varchar COMMENT '记录人姓名',
  `conlv` varchar COMMENT '密级',
  `vali_flag` varchar COMMENT '有效标志',
  `memo` varchar COMMENT '备注',
  ...
  `optins_no` varchar COMMENT '经办机构编号',
  `poolarea_no` varchar COMMENT '统筹区编号',
  `crte_optins` varchar COMMENT '创建机构编号',
  `optins` varchar COMMENT '经办机构编号',
  `admdvs` varchar COMMENT '医保区划',
  `poolarea` varchar COMMENT '统筹区编号',
  `psn_cert_type` varchar COMMENT '证件类型',
  `certno` varchar COMMENT '证件号码',
  PRIMARY KEY (`ADM_EVAL_RCD_SN`)
)
PARTITION BY HASH KEY (`ADM_EVAL_RCD_SN`) PARTITION NUM 256
TABLEGROUP hsa_vms_yt_01
OPTIONS (UPDATETYPE='realtime')
COMMENT '入院评估记录'
;