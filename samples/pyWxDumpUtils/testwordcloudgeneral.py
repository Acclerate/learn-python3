...
def extract():
    ...
    # 将聊天记录保存到txt文件中
    with open('原始聊天记录chatroom_0_5539_1.txt', 'w+', encoding='utf-8') as file:
...
def process():
    ...
    content_lines = read_file('.\原始聊天记录chatroom_0_5539_1.txt')
...
def cut(content_lines):
    jieba.load_userdict('.\原始聊天记录chatroom_0_5539_1.txt')
